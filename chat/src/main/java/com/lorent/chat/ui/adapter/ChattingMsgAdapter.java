...
public class ChattingMsgAdapter extends BaseAdapter {
    ...
    private static final String tag = "ChattingMsgAdapter";

    private List<ChattingPeople> chattingPeoples = new ArrayList<>();
    ...
    public ChattingMsgAdapter(Context context, List<ChattingPeople> chattingPeoples) {
        ...
        initImageFetcher();
        Log.i(tag, "ChattingMsgAdapter over");
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        //需优化
        holder.iv_icon.setImageDrawable(xManager.getUserImage(mUsrmessage.getLastMsg().getUid()));
        holder.tv_niName.setText(mUsrmessage.getLastMsg().getUid());
    ...
    protected void initImageFetcher() {
        ImageFetcher imageFetcher = new ImageFetcher(context, 80, 80);
    ...
    @Override
    public int getCount() {
        return chattingPeoples == null ? -1 : chattingPeoples.size();
    }
