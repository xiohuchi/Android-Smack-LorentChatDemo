...
public class AddFriendAdapter extends BaseAdapter {
	...
	public AddFriendAdapter(Context context, List<User> lists) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		final Holder holder;
		if (convertView == null) {
			convertView = View.inflate(mContext, R.layout.fragment_user_item,null);
			holder = new Holder();
			holder.iv = (CircleImageView) convertView.findViewById(R.id.user_head);
			holder.tv_nick = (TextView) convertView.findViewById(R.id.nick_name);
