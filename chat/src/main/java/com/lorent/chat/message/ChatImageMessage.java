...
private ImageView mIvImage;
	...
	protected synchronized void  onFillMessage() {
		...
		SoftReference<Bitmap> softReference = LcUserManager.instance.mPhotoOriginalCache.get(mMsg.getContent());
	...
	public void putBitmap(){
		...
		LcUserManager.instance.mPhotoOriginalCache.put(mMsg.getContent(), new SoftReference<Bitmap>(mBitmap));
	}
